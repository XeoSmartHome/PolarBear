...
import RecipeImporterScreen from 'screens/RecipeImporterScreen';
...
const StackNavigator = () => {
    return (
        <Stack.Navigator initialRouteName={SCREENS.HOME}>
            ...
            />
            <Stack.Screen
                name={SCREENS.INGREDIENT_DETAILS}
                component={IngredientDetailsScreen}
            />
            <Stack.Screen
                name={SCREENS.CUSTOMIZE_GLASS}
                component={GlassCustomizationScreen}
            />
            <Stack.Screen
                name={SCREENS.RECIPE_EDITOR}
                component={RecipeEditorScreen}
            />
            <Stack.Screen
                name={SCREENS.RECIPE_IMPORTER}
                component={RecipeImporterScreen}
            />
            <Stack.Screen
                name={SCREENS.INGREDIENT_EDITOR}
